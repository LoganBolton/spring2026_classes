...
Datamining is the process of using statistics and machine learning to unconver non obvious patterns and trends across large datasets. 
...
# 2
Write 5 data mining functions and give an example for application of each one
of them ?

1) Generalization: Cleaning and aggregating the data into one place and then summarizing the main characteristics of the data.
